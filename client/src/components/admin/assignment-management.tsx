  ...
  const cancelAssignment = useMutation({
    ...
    onError: (error) => {
      ...
      toast({
        ...
        description: "There was an error cancelling the assignment.",
        variant: "destructive",
      });
    }
  });
  ...
  const checkInObserver = useMutation({
    ...
    onError: (error) => {
      ...
      toast({
        ...
        description: "There was an error checking in the observer.",
        variant: "destructive",
      });
    }
  });
  ...
  const checkOutObserver = useMutation({
    ...
    onError: (error) => {
      ...
      toast({
        ...
        description: "There was an error checking out the observer.",
        variant: "destructive",
      });
    }
  });
