...
export class MemStorage implements IStorage {
  ...
  private pollingStations: Map<number, PollingStation> = new Map();
  private assignments: Map<number, Assignment> = new Map();
  private formTemplates: Map<number, FormTemplate> = new Map();
  private reports: Map<number, Report> = new Map();
  private reportAttachments: Map<number, ReportAttachment> = new Map();
  private events: Map<number, Event> = new Map();
  private eventParticipations: Map<number, EventParticipation> = new Map();
  private faqs: Map<number, Faq> = new Map();
  private news: Map<number, News> = new Map();
  private messages: Map<number, Message> = new Map();
  private registrationForms: Map<number, RegistrationForm> = new Map();
  private userImportLogs: Map<number, UserImportLog> = new Map();
  private systemSettings: Map<number, SystemSetting> = new Map();
  private photoApprovals: Map<number, PhotoApproval> = new Map();
  private errorLogs: Map<number, ErrorLog> = new Map();
  
  private userIdCounter: number = 1;
  private profileIdCounter: number = 1;
  private documentIdCounter: number = 1;
  private stationIdCounter: number = 1;
  private assignmentIdCounter: number = 1;
  private formTemplateIdCounter: number = 1;
  private reportIdCounter: number = 1;
  private reportAttachmentIdCounter: number = 1;
  private eventIdCounter: number = 1;
  private participationIdCounter: number = 1;
  private faqIdCounter: number = 1;
  private newsIdCounter: number = 1;
  private messageIdCounter: number = 1;
  private registrationFormIdCounter: number = 1;
  private userImportLogIdCounter: number = 1;
  private systemSettingIdCounter: number = 1;
  private photoApprovalIdCounter: number = 1;
