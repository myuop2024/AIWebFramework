...
// Some clients send PATCH /projects/new when creating a project. Rather than
// issuing an HTTP redirect, we handle it here and create the project using the
// same logic as POST /projects.
